...
namespace AppStore.Controllers
{
  ...
  //Created one more controller inorder to understand the versioning
  [ApiVersion("2.0")]
  [ApiController]
  [Route("products")]  // for header based versioning
  //[Route("v{v:apiVersion}/products")]   // for URI based versioning
  ...
  public class ProductsV2_0Controller : ControllerBase
  {
    ...
    public ProductsV2_0Controller(ILogger<WeatherForecastController> logger, ShopContext shopContext)
    {
      _logger = logger;
    ...
    {
      IQueryable<Product> products = _shopContext.Products.Where(p=>p.IsAvailable==true); //just a change from v1 controller 
