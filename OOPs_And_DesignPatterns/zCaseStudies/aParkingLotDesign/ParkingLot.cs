...
namespace OOPs_And_DesignPatterns.zCaseStudies.aParkingLotDesign
{
  public class ParkingLot
  {
    ...
    private readonly int maxCompactCount;
    private readonly int maxLargeCount;
    private readonly int maxMotorbikeCount;
    private readonly int maxElectricCount;

    private Dictionary<String, EntrancePanel> entrancePanels;
    private Dictionary<String, ExitPanel> exitPanels;
    private Dictionary<String, ParkingFloor> parkingFloors;
    ...
    public ParkingTicket getNewParkingTicket(Vehicle vehicle)
    {
      ...
      {
        throw new InvalidOperationException("Parking full"); //ParkingFullException();
      }
    ...
    private bool incrementSpotCount(VehicleType type)
    {
      if (type == VehicleType.TRUCK || type == VehicleType.VAN)
      {
        largeSpotCount++;
